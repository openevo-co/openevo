...
const CONFIG_TEMPLATE = (botName: string) => `# OpenEvo Configuration
...
const AGENT_MD_TEMPLATE = (botName: string) => `---
provider: ollama
model: qwen3.5:2b
temperature: 0.7
max_tokens: 2048
...
const README_TEMPLATE = (botName: string) => `# ${botName}
...
export async function scaffoldProject(projectName: string, botName?: string) {
...
export async function addPlugin(projectPath: string, pluginName: string) {
